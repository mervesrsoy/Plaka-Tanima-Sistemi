import cv2
import numpy as np
import pickle   # Bu kütüphane yardımıyla, random forest algoritmasıyla eğittimiz modelimizi yazdırıp kaydetmiştik. aynı şekilde okuyabiliriz.
...
def plakaAyristir(mevcutPlaka):
    ...
    # PLaka her zaman en hazla 4 rakam ile biter.
    karakterAdim = 0
    for i in range(len(mevcutPlaka)):
